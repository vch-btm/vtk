...
def timer_callback(obj, event):
    ...
    actMesh[...] = displacements[updateVec[count][1]]
...
def readFilesToDicomArray(path_in, path_out):
    ...
    if withCushion:
        allPositionList = np.genfromtxt("{}withCushion/avg_{}/listInfo.txt".format(path_out, numAvg), dtype='str',
                                        delimiter="  ")
    else:
        allPositionList = np.genfromtxt("{}noCushion/avg_{}/listInfo.txt".format(path_out, numAvg), dtype='str',
                                        delimiter="  ")
...
if withCushion:
    ...
    actVec = np.loadtxt("{}noCushion/avg_{}/path_{}_NoRot.txt".format(pathOut, numAvg, pathToDisplay), dtype=int)

# actVec = np.loadtxt("/home/horakv/Desktop/results/noCushion/path_{}.txt".format(pathToDisplay), dtype=int)
