...
def timer_callback(obj, event):
    ...
    images[0].GetPointData().SetScalars(listOfVTKDataLists[0][updateVectors[0][count]])
    ...
    tempCount = timeVectors[minDiffAtPos][updateVectors[minDiffAtPos][count]]#updateVectors[count][1]

    ren.AddActor(allCuts[tempCount])
    #ren.AddActor(allMMappers[tempCount])  # LAURA
...
for actT in range(maxCount):
    ...
    #allMMappers.append(mActor)  # LAURA
